...
const applicantResumeScore = asyncHandler( async (req, res) => {
  ...
  try {
    ...
    // const resumePath = req.file?.path;
    const resumePath = "/Users/pawantiwari/Desktop/ResumeProject/Resumeserverside/" + rp1;
...
const recruterResumeScore = asyncHandler( async (req, res) => {
  ...
  try {
    ...
    for (const fileName of rp2) {
      const resumePath = "/Users/pawantiwari/Desktop/ResumeProject/Resumeserverside/" + fileName;
      if (!resumePath) {
        throw new apiError(400, "Resume file is missing");
      }
